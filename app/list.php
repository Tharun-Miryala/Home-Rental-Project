...
<?php include '../include/header.php';?>
	...
	<!-- Header nav -->	
	<nav class="navbar navbar-expand-lg navbar-dark fixed-top py-1" style="background-color:#212529;" id="mainNav">
...
<section class="wrapper" style="margin-left: 16%;margin-top: -23%;">
	<div class="container">
		<div class="row">
			...
			?>
			<h2>List of Home/Apartment Details</h2>
				<?php 
					foreach ($data as $key => $value) {						
						echo '<div class="card card-inverse card-info mb-3" style="padding:1%;">					
								  <div class="card-block">';
								  	echo '<a class="btn btn-success float-right" href="update.php?id='.$value['id'].'&act=';if(!empty($value['own'])){ echo "ap"; }else{ echo "indi"; } echo '">Edit</a>';
									 echo 	'<div class="row">
											<div class="col-4">
											...
											<h4 class="text-center">Room Details</h4>';
												...
												if(isset($value['sale'])){
													...
													if(isset($value['ap_number_of_plats']))
														echo '<div class="alert" role="alert"><p><b>Flat Number: </b>'.$value['ap_number_of_plats'].'</p></div>';
														         // alert-success
												if(isset($value['own'])){
								...
								echo '<a class="btn btn-info float-right">Complaint</a><br><br>';
					}
				?>				
			</div>
		</div>
