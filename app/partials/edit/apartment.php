<!-- <div class="row"> -->			
  <div class="col-md-11 col-xs-12 col-sm-12"><br>  	
  	<div class="alert alert-secondary" role="alert">
		...
		?>
  		<h2 class="text-center">Edit Apartment Room details</h2>
  		...
  		<form action="" method="POST">
			...
			<div class="row">
		  	 	<div class="col-md-4">
				  <div class="form-group">
				    <label for="email">Email id:<a style="color:red">*</a></label>
			...
			<div class="row">
			 ...
			 <div class="row">
			 	<div class="col-md-4">
				 <div class="form-group">
				    <label for="ap_number_of_plats">Flat Number:<a style="color:red">*</a></label>
				...
				<div class="col-md-4">
				 <div class="form-group">
				    <label for="rooms">Rooms:<a style="color:red">*</a></label>
			 ...
			 <div class="row">
			  ...
			  <div class="form-group">
			   ...
			   <div class="row">
			 	<div class="col-md-4">
			  <div class="form-group">
			    <label for="description">Description:<a style="color:red">*</a></label>
			  ...
			  <button type="submit" class="btn btn-info center" name='register_apartment' value="register_apartment">SUBMIT</button>
			</form>	
			</div>			
  	</div>
<!-- </div> -->	