<!-- <div class="row"> -->			
  <div class="col-md-11 col-xs-12 col-sm-12"><br>
  	<div class="alert alert-secondary" role="alert">
		...
		?>
  		<h2 class="text-center">Edit Registered Room Details</h2>
  		<form action="" method="POST">
			...
			<div class="row">
				 ...
				 <div class="col-md-4">
				  <div class="form-group">
				    <label for="rooms">Available Rooms:<a style="color:red">*</a></label>
			...
			<div class="row">
			 ...
			 <div class="row">
			 	<div class="col-md-2">
			 <div class="form-group">
			    <label for="rent">Rent:<a style="color:red">*</a></label>
			 ...
			 <div class="form-group">
			  ...
			  <div class="col-md-4">
			  <div class="form-group">
			    <label for="deposit">Deposit:<a style="color:red">*</a></label>
			  ...
			  <button type="submit" class="btn btn-info center" name='register_individuals' value="register_individuals">SUBMIT</button>
			</form>	
			</div>			
  	</div>
<!-- </div> -->