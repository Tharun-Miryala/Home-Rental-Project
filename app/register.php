...
<?php include '../include/header.php';?>
	...
	<!-- Header nav -->	
	<nav class="navbar navbar-expand-lg navbar-dark py-1" style="background-color:#212529;" id="mainNav">
      <div class="container">
...
<section class="wrapper" style="margin-left: 16%;margin-top: -11%;">
	...
	<ul class="nav nav-tabs" role="tablist">
	  <li class="nav-item">
	    <a class="nav-link active" data-toggle="tab" href="#home" role="tab">Home Register Individual</a>
	  </li>
	  <li class="nav-item">
