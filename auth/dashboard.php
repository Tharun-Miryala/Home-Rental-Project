...
<?php include '../include/header.php';?>	
	...
	<!-- Header nav -->	
	<nav class="navbar navbar-expand-sm navbar-dark py-1" style="background-color:#212529;" id="mainNav">
      <div class="container">
					...
					<div class="row">						
						<?php 
							if($_SESSION['role'] == 'admin'){ 
								...
								echo '<a href="../app/users.php"><div class="alert alert-primary" role="alert">';
								echo '<b>Registered Users: <span class="badge badge-pill badge-dark">'.$count['register_user'].'</span></b>';
								echo '</div></a>';
								echo '</div>';
							} 
						?>	
						<?php 
							if($_SESSION['role'] == 'admin'){ 
								echo '<div class="col-md-3">';
								echo '<a href="../app/list.php"><div class="alert alert-primary" role="alert">';
								echo '<b>Rooms for Rent: <span class="badge badge-pill badge-dark">'.(intval($total_rent['total_rent'])+intval($total_rent_apartment['total_rent_apartment'])).'</span></b>';
								echo '</div></a>';
								echo '</div>';
							} 
						?>
						<?php 
							if($_SESSION['role'] == 'user'){ 
								echo '<div class="col-md-3">';
								echo '<a href="../app/list.php"><div class="alert alert-primary" role="alert">';
								echo '<b>Registered Rooms: <span class="badge badge-pill badge-dark">'.$total_auth_user_rent['total_auth_user_rent'].'</span></b>';
								echo '</div></a>';
								echo '</div>';
							} 
						?>
