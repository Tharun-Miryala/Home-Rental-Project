...
<?php include '../include/header.php';?>
	...
	<!-- Services -->
	<nav class="navbar navbar-expand-sm navbar-dark py-2" style="background-color:#212529;" id="mainNav">
      <div class="container">
			  ...
			  <div class="col-md-10 mx-auto">
			  	<div class="alert alert-secondary" role="alert">
					...
					?>
					  ...
					  <button type="submit" class="btn btn-info col-3 right" name='register' value="register">Submit</button>
