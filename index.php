...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <!-- Navigation -->
    <nav class="navbar navbar-expand-sm navbar-dark fixed-top py-1" id="mainNav">
      <div class="container">
        
        <a class="navbar-brand js-scroll-trigger" href="#page-top">WebsiteLogo</a>
    ...
    <header class="masthead">
      <div class="container">
        <div class="intro-text">
          <div class="intro-lead-in">Welcome To Room Rental and property Registration!</div>
          <div class="intro-heading text-uppercase">You can search at here<br></div>
        </div>
      </div>
    </header>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-11 text-center">
            ...
            <h3 class="section-subheading text-muted">Search for homes and property at hire.</h3>
          </div>
        </div>
          ...
          <div class="col-md-12">
            <form action="" method="POST" class="center" novalidate>
              ...
              <div class="row">
                ...
                <div class="center">
                  <div class="form-group">
                    <button id="" class="btn btn-info btn-md text-uppercase active" name="search" value="search" type="submit">Search</button><br><br>
                  </div>
                </div>
              </div>
    ...
    <footer style="background-color: #ccc;">
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-4">
            <ul class="list-inline social-buttons center">
